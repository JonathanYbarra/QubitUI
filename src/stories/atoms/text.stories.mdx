...
<Canvas>
  <Story name="Colors">
    ...
    <Text variant="p" color="tertiary">This is a tertiary text</Text>
    <Text variant="p" color="error">This is a error text</Text>
    <Text variant="p" color="success">This is a success text</Text>
  </Story>
</Canvas>
